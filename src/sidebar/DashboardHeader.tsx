          ...
          <DropdownMenuTrigger asChild>
            <div className="flex items-center gap-3 pl-2 border-l border-white/10 cursor-pointer group">
              <div className="text-right leading-tight hidden sm:block">
                <p className="text-xs font-black text-white group-hover:text-amber-400 transition-colors uppercase tracking-tight">
                  {userName}
                </p>
                <div className="flex items-center justify-end gap-1">
                  <span
                    className={`w-1 h-1 rounded-full ${user?.isActive ? "bg-green-500" : "bg-gray-500"}`}
                  />
